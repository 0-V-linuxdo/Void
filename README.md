...
| <img src="https://api.iconify.design/lucide/panel-left.svg?color=%238b949e" width="16" height="16" alt=""> BetterSidebar | On | Sidebar improvements: section-header action hover, New chat plus on Chats, and Bots default collapsed (`titleRowHover`, `chatsPlus`, `botsDefaultCollapsed`). |
