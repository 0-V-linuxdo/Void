...
interface SvgOverrides {
    viewBox?: string;
    fill?: string;
    stroke?: string;
}

const svg = (props: IconProps, children: React.ReactNode[], overrides?: SvgOverrides) => (
    <svg
        width={props.size ?? "1em"}
        height={props.size ?? "1em"}
        viewBox={overrides?.viewBox ?? "0 0 24 24"}
        fill={overrides?.fill ?? "none"}
        stroke={overrides?.stroke ?? "currentColor"}
        strokeWidth={overrides?.stroke === "none" ? undefined : (props.strokeWidth ?? 2)}
        strokeLinecap={overrides?.stroke === "none" ? undefined : "round"}
        strokeLinejoin={overrides?.stroke === "none" ? undefined : "round"}
...
export const Cross2Icon = (props: IconProps = {}) =>
    ...
    ], { viewBox: "0 0 15 15", fill: "none", stroke: "none" });
