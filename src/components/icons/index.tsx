...
export const Cross2Icon = (props: IconProps = {}) => (
    <svg width={props.size ?? "1em"} height={props.size ?? "1em"} viewBox="0 0 15 15" fill="none" className={props.className} aria-hidden="true">
...
export const GhostFilledIcon = (props: IconProps = {}) => (
    <svg width={props.size ?? "1em"} height={props.size ?? "1em"} viewBox="0 0 24 24" fill="currentColor" className={props.className} aria-hidden="true">
