...
| 功能 | 默认 | 说明 |
| --- | --- | --- |
| <img src="https://api.iconify.design/lucide/brush-cleaning.svg?color=%238b949e" width="16" height="16" alt=""> Cleaner 默认开启 | 开 | 上游已有该插件；Void++ 改为默认打开。隐藏升级提示、首页横幅、输入栏 SuperGrok 标记，以及锁定模型。 |
...
| <img src="https://api.iconify.design/lucide/scroll-text.svg?color=%238b949e" width="16" height="16" alt=""> ThemedScrollbar | 开 | 工程栏滚动条跟随 Grok 亮色 / 暗色主题。 |
...
| <img src="https://api.iconify.design/lucide/plus.svg?color=%238b949e" width="16" height="16" alt=""> BotsPlusHover | 开 | 侧栏 Bots 标题右侧加号仅在悬停时显示，与 Projects 一致。 |
